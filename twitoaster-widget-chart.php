...
//------------------------------------------------------------------------------
// Widget - Twitoaster / Twitter Chart
//------------------------------------------------------------------------------
	...
	function widget_twitoaster_chart($args)
	{
		...
		if ($twitoaster_options['api_key'] != '') {
			...
			$chart_content = '<p><a href="' . $twitoaster_options['profile'] . '" title="@' . $twitoaster_options['screen_name'] . ' conversations"><img src="' . $chart_url . '" width="' . $chart_size['width'] . '" height="' . $chart_size['height'] . '" alt="' . $twitoaster_options['screen_name'] . ' mentions" class="twitoaster_widget_chart" /></a></p>';
		}
...
//------------------------------------------------------------------------------
// Widget - Twitoaster / Twitter Chart Config (Admin Page)
//------------------------------------------------------------------------------
	...
	function widget_twitoaster_chart_options($options) {
		...
		$currentoptions['title'] = empty( $options['title'] ) ? '@' . $twitoaster_options['screen_name'] . ' mentions' : apply_filters('widget_title', $options['title']);
