...
//------------------------------------------------------------------------------
// Widget - Twitoaster / Twitter Conversation
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// Widget - Twitoaster / Twitter Conversation Config (Admin Page)
//------------------------------------------------------------------------------
	...
	function widget_twitoaster_conversation_control()
	{
		...
		if ($twitoaster_options['api_key'] != '') {
			...
			?>
				...
				<p>
					<label><input name="twitoaster-conversation-hide-no-replies" id="twitoaster-conversation-hide-no-replies" value="yes" type="checkbox"<?php checked($currentoptions['hide_no_replies'], 'yes'); ?> /> Hide conversations without mentions (replies or retweets)</label>
				</p>
